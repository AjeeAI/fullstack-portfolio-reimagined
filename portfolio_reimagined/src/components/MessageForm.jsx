...
const MessageForm = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            setLoading(true);
            const response = await fetch("https://portfolio-backend-wki6.onrender.com/api/messages", {
                method: "POST",
                headers: {
