import { db } from './firebase'; // Ensure this path points to your actual firebase config file
  ...
  try {
    ...
    for (const project of projectsData) {
      await addDoc(projectsRef, {
        ...project,
        createdAt: serverTimestamp() // Add this so you can sort them easily in Next.js
      });
      console.log(`✅ Successfully uploaded: ${project.name}`);
    }
    
    console.log("🎉 ALL PROJECTS SEEDED SUCCESSFULLY!");
    alert("Database seeded successfully! Check your console/Firebase.");
  } catch (error) {
